...
ComponentFactory.prototype.getApplicationInterface = function(config, callback) {
  return this.getComponent("applicationInterface", config, callback); 
}
ComponentFactory.prototype.getClientInterface = function(config, callback) {
  return this.getComponent("clientInterface", config, callback);
}
ComponentFactory.prototype.getDatabase = function(config, callback) {
  return this.getComponent("database", config, callback);
}
ComponentFactory.prototype.getLog = function(config, callback) {
