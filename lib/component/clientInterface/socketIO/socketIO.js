...
p._configure = function(thywill, config, callback) {
  ...
  var fns = [
    ...
    function(resources, asyncCallback) {
      ...
      // and set the Express server appropriately
      self.thywill.server.get(self.config.basePath + "/jquery.js", function(res, req) { self._handleResourceRequest(res, req); });
      self.thywill.server.get(self.config.basePath + "/thywill.js", function(res, req) { self._handleResourceRequest(res, req); });
      ...
      for( var i = 0, length = resources.length; i < length; i++ ) {
        ...
        self.thywill.server.get(resources[i].path, function(res, req) { self._handleResourceRequest(res, req); });
      }
